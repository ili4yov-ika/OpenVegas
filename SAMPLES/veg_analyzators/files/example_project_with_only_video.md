# `example_project_with_only_video.veg`

## Роль сэмпла

Только видео на таймлайне
...
|------|----------|
| Size | 13600 bytes |
| MD5 | `973ddddedc5a7cff340182dc84d9277e` |
| Filesize field @0x10 | 13600 |
| Early blob @0x38 | 3808 |
...
`D:\Devs\C++\OpenVegas\sample_ui\example_project_with_only_video.veg`
...
000010  20 35 00 00 00 00 00 00 EF 29 C4 46 4A 90 D2 11    5.......).FJ...
000020  87 22 00 C0 4F 8E DB 8A 5A 2D 8F B2 0F 23 D2 11   ."..O...Z-...#..
000030  86 AF 00 C0 4F 8E DB 8A E0 0E 00 00 00 00 00 00   ....O...........
...
000070  00 00 00 00 00 00 00 00 03 00 00 00 88 00 00 00   ................
```

## Рассуждения

- Ранний блоб (~3808 B) содержит props + путь проекта + ProjectNotes; дальше — медиа-пул и таймлайн.
- Размер **13600** согласуется с ролью «Только видео на таймлайне»: больше событий/сегментов → больше хвост файла.
