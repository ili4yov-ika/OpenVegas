# `example_project_with_video_and_audio.veg`

## Роль сэмпла

Базовый проект video+audio
...
|------|----------|
| Size | 14256 bytes |
| MD5 | `5b625b92f6819b5560c9dc4137e8226c` |
| Filesize field @0x10 | 14256 |
| Early blob @0x38 | 3816 |
...
`D:\Devs\C++\OpenVegas\sample_ui\example_project_with_video_and_audio.veg`
...
000070  00 00 00 00 00 00 00 00 03 00 00 00 92 00 00 00   ................
```

## Рассуждения

- Ранний блоб (~3816 B) содержит props + путь проекта + ProjectNotes; дальше — медиа-пул и таймлайн.
- Размер **14256** согласуется с ролью «Базовый проект video+audio»: больше событий/сегментов → больше хвост файла.
