# `example_project_with_only_audio.veg`

## Роль сэмпла

Только аудио на таймлайне
...
|------|----------|
| Size | 12200 bytes |
| MD5 | `cdbe48b1e3a1becd4eab438c7c640d6e` |
| Filesize field @0x10 | 12200 |
...
`D:\Devs\C++\OpenVegas\sample_ui\example_project_with_only_audio.veg`
...
000010  A8 2F 00 00 00 00 00 00 EF 29 C4 46 4A 90 D2 11   ./.......).FJ...
...
- Размер **12200** согласуется с ролью «Только аудио на таймлайне»: больше событий/сегментов → больше хвост файла.
