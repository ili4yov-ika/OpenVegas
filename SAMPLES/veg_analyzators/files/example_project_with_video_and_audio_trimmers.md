# `example_project_with_video_and_audio_trimmers.veg`

## Роль сэмпла

Видео+аудио с несколькими тримами/сегментами
...
|------|----------|
| Size | 19448 bytes |
| MD5 | `8b7135145c87e14eb07b1377b254ffa8` |
| Filesize field @0x10 | 19448 |
...
`D:\Devs\C++\OpenVegas\sample_ui\example_project_with_video_and_audio_trimmers.veg`
...
- `sample_for_project_audio` (×2)
- `sample_for_project_video` (×10)
...
000010  F8 4B 00 00 00 00 00 00 EF 29 C4 46 4A 90 D2 11   .K.......).FJ...
...
000070  00 00 00 00 00 00 00 00 03 00 00 00 A4 00 00 00   ................
```

## Рассуждения

- Ранний блоб (~3832 B) содержит props + путь проекта + ProjectNotes; дальше — медиа-пул и таймлайн.
- Размер **19448** согласуется с ролью «Видео+аудио с несколькими тримами/сегментами»: больше событий/сегментов → больше хвост файла.
