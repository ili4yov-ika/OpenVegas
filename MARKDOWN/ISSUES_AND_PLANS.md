...
| Media Generator — прочие плагины (Checkerboard, Color Gradient, Solid Color, …) | Каталог + превью есть, рендер-бэкенда нет (в отличие от Titles & Text) | По мере необходимости |
