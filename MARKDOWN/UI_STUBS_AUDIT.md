...
Из 97 просмотренных кнопок **39 не делает ничего** (16 без обработчика + 23 «на выброс»).
Из 171 поля ввода — **29** без потребителя. Счётчик кнопок вырос на 6: пять в новом окне
Capture и «Remove Transition» в настройках перехода — все подключены.
